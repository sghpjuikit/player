...
![ScreenShot](/extra/screenshot1.jpg)
![ScreenShot](/extra/screenshot2.jpg)


use:

To run the application download the [a link](/extra/executable.zip), extract to arbitrary location and run the Player.jar file.
