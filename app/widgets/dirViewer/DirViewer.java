...
import sp.it.pl.main.FileFilterValue;
...
import static sp.it.pl.util.async.AsyncKt.burstTPExecutor;
...
public class DirViewer extends SimpleController {
    ...
    private final ExecutorService executorThumbs = burstTPExecutor(8, minutes(1), threadFactory("dirView-img-thumb", true));
    private final ExecutorService executorImage = burstTPExecutor(8, minutes(1), threadFactory("dirView-img-full", true));
