...
//                long duration = Math.round(totalSamples / sampleRate);
//		props.put("duration", new Long(duration * 1000000L));
//		props.put("audio.channels", channels);
//		props.put("audio.length.bytes", new Integer(streamInfo.getMinBlockSize()));
//		props.put(KEY_BLOCKSIZE_MAX, new Integer(streamInfo.getMaxBlockSize()));
//		props.put(KEY_BLOCKSIZE_MAX, new Integer(streamInfo.getMaxBlockSize()));
	}
