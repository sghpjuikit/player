...
//        
//        actPane = new VBox();
//        actB = Util.createIcon(AwesomeIcon.CODE, 80, "Set as Cover", e->((Area)actPane.getUserData()).setActivityVisible(false));
//        actPane.getChildren().addAll(actB);
////        actPane.setOnMouseClicked(e->((Area)actPane.getUserData()).setActivityVisible(false));
////        actPane.setOnMouseExited(e->((Area)actPane.getUserData()).setActivityVisible(false));
////        actPane.setOnMouseDragExited(e->((Area)actPane.getUserData()).setActivityVisible(false));
//        actPane.setOnDragExited(e->((Area)actPane.getUserData()).setActivityVisible(false));
//    }
//    
//    private Labeled actB;
//    private VBox actPane;
//
//    @Override
//    public Node getActivityNode() {
