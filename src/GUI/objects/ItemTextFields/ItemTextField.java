 ...
 * @author Plutonium_
 */
public abstract class ItemTextField<T, P extends StringParser<T>> extends CustomTextField {
    ...
    /**
     * Default implementation uses provided parser. Default implementation of
     * value factory uses invokes this method.
     * @param item
...
//        new TextField().getStyleClass().forEach(System.out::println); 
        ...
        // general but not optimal solution
...
/******************************************************************************/
     ...
     * The button is completely normal except for having its own css style class 
     * "dialog-button".
     * <p>
     * @author Plutonium_
     */
