...
/****************************** SERIALIZATION *********************************/
    ...
    private void storeConfigs() {
        ...
        // manually, thus we should only take care of it.
...
//    @XStreamOmitField
//    @Dependency("name - acceesed using reflection by name")
//    @IsConfig(name = "Custon name", info = "Name displayed in gui. User can set his own. By default component type name.")
//    public final V<String> custom_name = new V<>("");
//
//
//    /**
...
//
//        if(configs==null) configs = new HashMap<>();
//        if(preferred==null) util.Util.setField(this, "preferred", new V<Boolean>(false));
//        if(forbid_use==null) util.Util.setField(this, "forbid_use", new V<Boolean>(false));
//        if(custom_name==null) util.Util.setField(this, "custom_name", new V<String>(name));
//
//        // accumulate serialized inputs for later deserialiation when all widgets are ready
//        properties.entrySet().stream()
//                  .filter(e -> e.getKey().startsWith("io"))
