...
public abstract class Item<CT extends Item> {
	...
	/**
	 * @return non null URI of the audio resource of this item.
	 */
	 ...
	 *
	 * @return metadata that tests true for {@link #same(Item)} with this item.
	 * @implSpec Metadata has private constructors. The responsibility for creating Metadata from any Item object lies
	 * within Metadata's constructor which uses reflection to inspect the Item type. Subclassing this class should
	 * include modifying that constructor to take the subclass into consideration.
	 */
	 ...
	 * preserved.
	 *
	 * @return simple item representation retaining of this item retaining the identity.
	 */
	 ...
	 *
	 * @return playlistItem that tests true for {@link #same(Item)} with this item.
	 */
