...
class DateTimeTextField(initialValue: LocalDateTime? = null, locale: Locale = Locale.getDefault(), formatter: DateTimeFormatter): ValueTextField<LocalDateTime>(
   initialValue, { it?.net(formatter::format) ?: AppTexts.textNoVal }
) {
