...
import sp.it.pl.audio.playback.player.xtrememp.audio.AudioPlayer;
import sp.it.pl.audio.playback.player.xtrememp.audio.PlaybackEvent;
import sp.it.pl.audio.playback.player.xtrememp.audio.PlaybackListener;
import sp.it.pl.audio.playback.player.xtrememp.audio.PlayerException;
import static javafx.scene.media.MediaPlayer.Status.PAUSED;
import static javafx.scene.media.MediaPlayer.Status.PLAYING;
import static javafx.scene.media.MediaPlayer.Status.STOPPED;
import static javafx.util.Duration.millis;
import static sp.it.pl.audio.playback.PLAYBACK.state;
import static sp.it.pl.audio.playback.state.VolumeProperty.linToLog;
