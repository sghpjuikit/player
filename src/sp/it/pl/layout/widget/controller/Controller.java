 ...
 * For more about how to use Controller without relying on type safety, read {@link sp.it.pl.layout.widget.feature.Feature}.
 * <p/>
 ...
 * <p/>
 * Implements {@link sp.it.pl.util.conf.Configurable} interface which is useful for
 * user customization of internal properties.
 * <p/>
 * It is intended for controller to implement {@link sp.it.pl.layout.widget.feature.Feature} interfaces.
 * <p/>
 ...
 * - controller is assigned widget permanently (using reflection)
...
public interface Controller extends CachedConfigurable<Object>, Locatable {
	 ...
	 * <p/>
	 * If the contorller makes use of the {@link sp.it.pl.util.conf.IsConfig} anotated properties,
	 ...
	 * At this point all {@link sp.it.pl.util.conf.IsConfig configs}
	 ...
	 * means there is no content in the widget whatsoever, but it depends
	 * on implementation.
	 * <p/>
