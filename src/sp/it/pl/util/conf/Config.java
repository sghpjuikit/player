...
import static sp.it.pl.util.type.Util.getValueFromFieldMethodHandle;
...
//			return () -> list.removeListener(listener);
	...
	/**
	 * Functional implementation of {@link sp.it.pl.util.conf.Config} that does not store nor wrap the
	 ...
	 * See {@link sp.it.pl.util.access.FAccessor} which this config implements.
	 * <p/>
