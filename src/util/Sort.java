...
public enum Sort {
	...
	/**
	 * Modifies a comparator to uphold the sorting type. If this is descending, new reverse comparator is returned,
	 ...
	 * <p/>
	 * Applying this method multiple times will not produce any new comparator instances. {@link #ASCENDING} and {@link
	 * #NONE} will consistently return the same instance and {@link #DESCENDING} will flip between the reverse and
