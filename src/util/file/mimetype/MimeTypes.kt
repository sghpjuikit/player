...
object MimeTypes {
     ...
     */
    fun ofType(type: String): MimeType {
        return (types as java.util.Map<String, MimeType>).getOrDefault(type, MimeType.UNKNOWN)
    }
    ...
    fun ofExtension(extension: String): MimeType {
        return (extensions as java.util.Map<String, MimeType>).getOrDefault(extension.toLowerCase(), MimeType.UNKNOWN)
    }

    fun ofFile(file: File): MimeType {
        return (extensions as java.util.Map<String, MimeType>).getOrDefault(getSuffix(file).toLowerCase(), MimeType.UNKNOWN)
    }

    fun ofURI(url: URI): MimeType {
        return (extensions as java.util.Map<String, MimeType>).getOrDefault(getSuffix(url).toLowerCase(), MimeType.UNKNOWN)
    }
