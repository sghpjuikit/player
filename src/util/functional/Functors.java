...
public class Functors {
    ...
    static {
        add("'_' -> ' '", String.class, s -> s.replace("_", " "));
        add("-> file name", String.class, Util::filenamizeString);
        add("Anime", String.class, s -> {
        ...
        add("Plural",       String.class, (t) -> plural(t));
        add("Replace 1st",  String.class, (t,o,n) -> t.replaceFirst(o,n), String.class, String.class ,"","");
        add("Replace all",  String.class, (t,o,n) -> t.replaceAll(o,n), String.class, String.class,"","");
        add("Remove first", String.class, (t,r) -> t.replaceFirst(r, ""), String.class,"");
        add("Remove all",   String.class, (t,r) -> t.replaceAll(r, ""), String.class,"");
        add("Text",         String.class, (t,r) -> r, String.class,"");
        add("Add text",     String.class, (t,a,d) -> d==FROM_START ? a+t : t+a, String.class, StringDirection.class,"",FROM_START);
        add("Remove chars", String.class, (t,i,d) -> d==FROM_START ? t.substring(min(i,t.length()-1)) : t.substring(0, max(t.length()-i,0)), Integer.class, StringDirection.class,0,FROM_START);
        add("Retain chars", String.class, (t,i,d) -> d==FROM_START ? t.substring(0,min(i,t.length()-1)) : t.substring(min(i,t.length()-1)), Integer.class, StringDirection.class,0,FROM_START);
        add("Split-join",   String.class, (t,spliter,joiner) -> {
            try {
        ...
        add("Matches regular expression", String.class,Boolean.class,(text,b) -> text.matches(b), String.class,"");
        ...
        add("Not matches regular expression", String.class,Boolean.class,(text,b) -> !text.matches(b), String.class,"");
        ...
        add("Longer than",      String.class,Boolean.class,(x,y) -> x.length()>Integer.parseInt(y), String.class,"");
        add("Shorter than",     String.class,Boolean.class,(x,y) -> x.length()<Integer.parseInt(y), String.class,"");
        add("Not longer than",  String.class,Boolean.class,(x,y) -> x.length()<=Integer.parseInt(y), String.class,"");
        add("Not shorter than", String.class,Boolean.class,(x,y) -> x.length()>=Integer.parseInt(y), String.class,"");
        add("Long exactly",     String.class,Boolean.class,(x,y) -> x.length()==Integer.parseInt(y), String.class,"");
    ...
    public static<IO> void add(String name, Class<IO> io, Function<IO,IO> f) {
        add(name,io,io,f);
    }
    public static<IO,P1> void add(String name, Class<IO> io, BiFunction<IO,P1,IO> f, Class<P1> p1, P1 p1def) {
        addF(new PF1(name,io,io,p1,p1def,f));
    }
    public static<IO,P1,P2> void add(String name, Class<IO> io, TriFunction<IO,P1,P2,IO> f, Class<P1> p1, Class<P2> p2, P1 p1def, P2 p2def) {
        addF(new PF2(name,io,io,p1,p2,p1def,p2def,f));
    }
    
    public static<I,O> void add(String name, Class<I> i ,Class<O> o, Function<I,O> f) {
        addF(new PF0(name,i,o,f));
    }
    public static<I,P1,O> void add(String name, Class<I> i, Class<O> o, BiFunction<I,P1,O> f, Class<P1> p1, P1 p1def) {
        addF(new PF1(name,i,o,p1,p1def,f));
    }
    public static<I,P1,P2,O> void add(String name, Class<I> i,Class<O> o, TriFunction<I,P1,P2,O> f, Class<P1> p1, Class<P2> p2, P1 p1def, P2 p2def) {
        addF(new PF2(name,i,o,p1,p2,p1def,p2def,f));
    }
    
    public static<IO> void add(String name, Class<IO> io, Function<IO,IO> f, boolean pi, boolean po, boolean pio) {
        add(name,io,io,f);
    }
    public static<IO,P1> void add(String name, Class<IO> io, BiFunction<IO,P1,IO> f, Class<P1> p1, P1 p1def, boolean pi, boolean po, boolean pio) {
        addF(new PF1(name,io,io,p1,p1def,f));
    }
    public static<IO,P1,P2> void add(String name, Class<IO> io, TriFunction<IO,P1,P2,IO> f, Class<P1> p1, Class<P2> p2, P1 p1def, P2 p2def, boolean pi, boolean po, boolean pio) {
        addF(new PF2(name,io,io,p1,p2,p1def,p2def,f));
    }
    
    public static<I,O> void add(String name, Class<I> i ,Class<O> o, Function<I,O> f, boolean pi, boolean po, boolean pio) {
        addF(new PF0(name,i,o,f),pi,po,pio);
    }
    public static<I,P1,O> void add(String name, Class<I> i, Class<O> o, BiFunction<I,P1,O> f, Class<P1> p1, P1 p1def, boolean pi, boolean po, boolean pio) {
        addF(new PF1(name,i,o,p1,p1def,f),pi,po,pio);
    }
    public static<I,P1,P2,O> void add(String name, Class<I> i,Class<O> o, TriFunction<I,P1,P2,O> f, Class<P1> p1, Class<P2> p2, P1 p1def, P2 p2def, boolean pi, boolean po, boolean pio) {
    ...
    public static abstract class PF<I,O> implements BiFunction<I,Object[],O>, Parameterized<Object> {
    ...
    public static class PF0<I,O> extends PF<I,O> {
        ...
        public PF0(String _name, Class<I> i, Class<O> o, Function<I,O> f) {
            super(_name,i,o);
            this.f = f;
        }
    ...
    public static class PF1<I,P1,O> extends PF<I,O> {
        private Class<P1> p1;
        private P1 p1def;
        private BiFunction<I,P1,O> f;

        public PF1(String _name, Class<I> i, Class<O> o, Class<P1> p1type, P1 p1def, BiFunction<I,P1,O> f) {
            super(_name,i,o);
    ...
    public static class PF2<I,P1,P2,O> extends PF<I,O> {
        ...
        private P1 p1def;
        private P2 p2def;
        private TriFunction<I,P1,P2,O> f;
        
        public PF2(String _name, Class<I> i, Class<O> o, Class<P1> p1type, Class<P2> p2type, P1 p1def, P2 p2def, TriFunction<I,P1,P2,O> f) {
            super(_name,i,o);
            this.p1 = unPrimitivize(p1type);
