...
import static sp.it.util.conf.ConfigurationUtil.configsOf;
import static sp.it.util.conf.ConfigurationUtil.createConfig;
import static sp.it.util.functional.Util.list;
import static sp.it.util.type.Util.forEachJavaFXProperty;

/**
 * Defines object that can be configured.
 * <p/>
 * Configurable object exports its configurable state as {@link sp.it.util.conf.Config} fields that
 ...
 * discovering fields with {@link sp.it.util.conf.IsConfig} annotation.
 * <p/>
