...
public final class FileSize implements Comparable<FileSize> {
	 ...
	 *
	 * @param bytes amount of bytes as a size value or -1 if unknown.
	 ...
	 * Creates file size set to specified value.
	 *
	 * @param bytes of bytes as String, optionally with unit appended. Consistent with {@link #toString()}.
	 */
	@ParsesFromString
	...
	/**
	 * @return whether the value is known/specified
	 */
