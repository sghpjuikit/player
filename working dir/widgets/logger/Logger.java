...
//		System.setErr(con);
	...
	/**
	 * Implementation based on http://stackoverflow.com/questions/3340342/java-writing-to-the-real-stdout-after-system-setout.
	 * Maybe it will e useful.
	 */
	static class TextOutputStream<T> extends OutputStream {

		private byte[] oneByte; // array for write(int val);
		private Appender<T> appender; // most recent action
	...
	static class TextAreaStream extends TextOutputStream<TextArea> {
		...
		public TextAreaStream(TextArea txtara) {
			super(txtara, new AppenderHandler<>() {
